...
% ----------------------------------------------------------------------------
function hfssSilicon(fid, Name, Er, bSigma, tanDelta)
...
fprintf(fid, '"dielectric_loss_tangent:=", "%f")\n', tanDelta);
     ...
     _
  "11.9", "conductivity:=", "10", "thermal_conductivity:=", "148", "mass_density:=",  _
  "2330", "specific_heat:=", "712", "youngs_modulus:=", "135000000000", "poissons_ratio:=",  _
  "0.25", "thermal_expansion_coeffcient:=", "2.54e-006")
